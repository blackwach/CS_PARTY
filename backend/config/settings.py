...
CS2_STATS_API_TIMEOUT_SECONDS = int(os.getenv('CS2_STATS_API_TIMEOUT_SECONDS', '45') or '45')
CS2_MATCH_TOKEN_ENCRYPTION_KEY = os.getenv('CS2_MATCH_TOKEN_ENCRYPTION_KEY', '')
